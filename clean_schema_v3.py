...
def clean_schema_sql_v3():
    input_file = "C:/Users/bigey/Documents/Antigravity/L2C/alibabacloud-rds-openapi-mcp-server/schema.sql"
    output_file = "C:/Users/bigey/Documents/Antigravity/L2C/schema_cleaned_v3.sql"
    
    print("=" * 60)
    print("高级清理 Schema SQL 文件 V3")
    print("=" * 60)
    ...
    for line in lines:
        ...
        # 对于 ALTER TABLE ADD CONSTRAINT，不使用 IF NOT EXISTS
        # 而是包装在 DO 块中
