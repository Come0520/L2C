...
- [ ] **[Quote-02] 商品下拉选择不可点击**
  - 问题：报价页面商品下拉菜单可以显示商品，但点击后无响应
  - 发现时间：2026-01-25
  - 待排查：检查商品选择组件的 onClick 事件绑定

- [ ] **[Quote-03] 价格计算返回 0 / NaN**
  - 问题：添加商品后单价和小计显示为 ¥0.00，计算返回 NaN
...
- [ ] **[Product-01] 商品管理页面无法保存**
  - 问题：编辑商品后无法保存
  - 发现时间：2026-01-25
  - 待排查：可能是表单验证或 API 问题

- [ ] **[Product-02] 渠道定价模式位置错误**
  - 问题：渠道定价模式不应该显示在商品管理页面
  - 位置：商品编辑表单
  - 待办：将渠道定价模式移至渠道管理或渠道价格配置模块
