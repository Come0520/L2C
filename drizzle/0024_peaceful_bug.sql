...
ALTER TABLE "notification_queue" ALTER COLUMN "retry_count" SET DATA TYPE integer;--> statement-breakpoint
ALTER TABLE "notification_queue" ALTER COLUMN "max_retries" SET DATA TYPE integer;--> statement-breakpoint
