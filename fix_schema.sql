...
-- Column products.product_type is MISSING
ALTER TABLE "products" ADD COLUMN "product_type" product_type NOT NULL DEFAULT 'FINISHED';
-- Column products.images is MISSING
ALTER TABLE "products" ADD COLUMN "images" jsonb DEFAULT '[]'::jsonb;
-- Column products.stock_unit is MISSING
ALTER TABLE "products" ADD COLUMN "stock_unit" varchar(20);
-- Column products.sales_unit is MISSING
ALTER TABLE "products" ADD COLUMN "sales_unit" varchar(20);
-- Column products.conversion_rate is MISSING
ALTER TABLE "products" ADD COLUMN "conversion_rate" numeric(10, 4);
-- Table customer_merge_logs is MISSING
...
-- Column customers.wechat_openid is MISSING
ALTER TABLE "customers" ADD COLUMN "wechat_openid" varchar(100);
-- Column customers.updated_by is MISSING
ALTER TABLE "customers" ADD COLUMN "updated_by" uuid;
-- Table phone_view_logs is MISSING
CREATE TABLE IF NOT EXISTS "phone_view_logs" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "phone_view_logs_pkey" PRIMARY KEY ("id")
);

-- Table customer_addresses is MISSING
...
-- Table lead_activities is MISSING
...
-- Table lead_status_history is MISSING
...
-- Table channel_categories is MISSING
...
-- Table channel_commissions is MISSING
CREATE TABLE IF NOT EXISTS "channel_commissions" (
  ...
  "lead_id" uuid,
  "order_id" uuid,
  "commission_type" cooperation_mode,
...
-- Table channel_contacts is MISSING
...
-- Table channel_settlements is MISSING
...
CREATE TABLE IF NOT EXISTS "channels" (
  ...
  "category_id" uuid,
  "category" channel_category NOT NULL DEFAULT 'OFFLINE',
  "channel_type" channel_type NOT NULL,
  "name" varchar(100) NOT NULL,
  "code" varchar(50) NOT NULL,
  "level" channel_level NOT NULL DEFAULT 'C',
  ...
  "commission_trigger_mode" commission_trigger_mode DEFAULT 'PAYMENT_COMPLETED',
  "bank_info" jsonb,
...
-- Table commission_adjustments is MISSING
...
-- Table quote_plan_items is MISSING
...
-- Table quote_template_items is MISSING
...
-- Table quote_template_rooms is MISSING
CREATE TABLE IF NOT EXISTS "quote_template_rooms" (
  ...
  "sort_order" integer DEFAULT 0,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "quote_template_rooms_pkey" PRIMARY KEY ("id")
);

-- Table quote_templates is MISSING
...
-- Table order_changes is MISSING
...
CREATE TABLE IF NOT EXISTS "orders" (
  ...
  "channel_id" uuid,
  "channel_contact_id" uuid,
  "channel_cooperation_mode" cooperation_mode,
  "customer_id" uuid NOT NULL,
...
-- Table payment_schedules is MISSING
...
-- Table channel_discount_overrides is MISSING
CREATE TABLE IF NOT EXISTS "channel_discount_overrides" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "channel_discount_overrides_pkey" PRIMARY KEY ("id")
);

-- Table channel_specific_prices is MISSING
CREATE TABLE IF NOT EXISTS "channel_specific_prices" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "product_id" uuid NOT NULL,
  "channel_id" uuid NOT NULL,
  ...
  "is_active" boolean DEFAULT true,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "channel_specific_prices_pkey" PRIMARY KEY ("id")
);

-- Table fabric_inventory is MISSING
...
-- Table fabric_inventory_logs is MISSING
CREATE TABLE IF NOT EXISTS "fabric_inventory_logs" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_by" uuid,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "fabric_inventory_logs_pkey" PRIMARY KEY ("id")
);

-- Table package_products is MISSING
...
-- Table product_bundle_items is MISSING
...
-- Table product_bundles is MISSING
...
-- Table product_packages is MISSING
...
-- Table product_suppliers is MISSING
...
-- Table production_tasks is MISSING
...
-- Table purchase_order_items is MISSING
...
-- Table purchase_orders is MISSING
...
-- Table split_route_rules is MISSING
CREATE TABLE IF NOT EXISTS "split_route_rules" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "split_route_rules_pkey" PRIMARY KEY ("id")
);

-- Table suppliers is MISSING
CREATE TABLE IF NOT EXISTS "suppliers" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "supplier_no" varchar(50) NOT NULL,
  "name" varchar(200) NOT NULL,
  "supplier_type" supplier_type DEFAULT 'SUPPLIER',
...
-- Table work_order_items is MISSING
CREATE TABLE IF NOT EXISTS "work_order_items" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "wo_id" uuid NOT NULL,
  "order_item_id" uuid NOT NULL,
  "status" work_order_item_status DEFAULT 'PENDING',
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "work_order_items_pkey" PRIMARY KEY ("id")
);

-- Table work_orders is MISSING
...
-- Table install_items is MISSING
CREATE TABLE IF NOT EXISTS "install_items" (
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "install_items_pkey" PRIMARY KEY ("id")
);

-- Table install_photos is MISSING
CREATE TABLE IF NOT EXISTS "install_photos" (
  ...
  "remark" text,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "install_photos_pkey" PRIMARY KEY ("id")
);

-- Table install_tasks is MISSING
CREATE TABLE IF NOT EXISTS "install_tasks" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "task_no" varchar(50) NOT NULL,
  "source_type" install_task_source_type NOT NULL DEFAULT 'ORDER',
  "order_id" uuid NOT NULL,
  "after_sales_id" uuid,
  "customer_id" uuid NOT NULL,
  "customer_name" varchar(100),
  "customer_phone" varchar(20),
  "address" text,
  "category" install_task_category NOT NULL DEFAULT 'CURTAIN',
  "status" install_task_status NOT NULL DEFAULT 'PENDING_DISPATCH',
  "sales_id" uuid,
  "dispatcher_id" uuid,
  "installer_id" uuid,
...
-- Table measure_items is MISSING
CREATE TABLE IF NOT EXISTS "measure_items" (
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "measure_items_pkey" PRIMARY KEY ("id")
);

-- Table measure_sheets is MISSING
CREATE TABLE IF NOT EXISTS "measure_sheets" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "measure_sheets_pkey" PRIMARY KEY ("id")
);

-- Table measure_task_splits is MISSING
CREATE TABLE IF NOT EXISTS "measure_task_splits" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_by" uuid,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "measure_task_splits_pkey" PRIMARY KEY ("id")
);

-- Table measure_tasks is MISSING
CREATE TABLE IF NOT EXISTS "measure_tasks" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "completed_at" timestamp with time zone,
  "deleted_at" timestamp with time zone,
  CONSTRAINT "measure_tasks_pkey" PRIMARY KEY ("id")
);

-- Table account_transactions is MISSING
...
-- Table ap_labor_fee_details is MISSING
CREATE TABLE IF NOT EXISTS "ap_labor_fee_details" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "statement_id" uuid NOT NULL,
  "install_task_id" uuid,
  "install_task_no" varchar(50),
  "liability_notice_id" uuid,
  "liability_notice_no" varchar(50),
  "fee_type" varchar(20) NOT NULL,
  "description" varchar(200) NOT NULL,
  "calculation" varchar(200) NOT NULL,
  "amount" numeric(12, 2) NOT NULL,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "ap_labor_fee_details_pkey" PRIMARY KEY ("id")
);

-- Table ap_labor_statements is MISSING
CREATE TABLE IF NOT EXISTS "ap_labor_statements" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "ap_labor_statements_pkey" PRIMARY KEY ("id")
);

-- Table ap_supplier_statements is MISSING
CREATE TABLE IF NOT EXISTS "ap_supplier_statements" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "statement_no" varchar(50) NOT NULL,
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "ap_supplier_statements_pkey" PRIMARY KEY ("id")
);

-- Table ar_statements is MISSING
CREATE TABLE IF NOT EXISTS "ar_statements" (
  ...
  "pending_amount" numeric(12, 2) NOT NULL,
  "status" ar_statement_status NOT NULL,
  "invoice_no" varchar(100),
  "invoiced_at" timestamp with time zone,
  "tax_rate" numeric(5, 4),
  "tax_amount" numeric(12, 2),
...
-- Table commission_records is MISSING
...
-- Table finance_accounts is MISSING
...
-- Table finance_configs is MISSING
...
-- Table internal_transfers is MISSING
...
-- Table payment_bill_items is MISSING
...
-- Table payment_bills is MISSING
...
-- Table payment_order_items is MISSING
...
-- Table payment_orders is MISSING
...
-- Table receipt_bill_items is MISSING
CREATE TABLE IF NOT EXISTS "receipt_bill_items" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "amount" numeric(12, 2) NOT NULL,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "receipt_bill_items_pkey" PRIMARY KEY ("id")
);

-- Table receipt_bills is MISSING
CREATE TABLE IF NOT EXISTS "receipt_bills" (
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "receipt_bills_pkey" PRIMARY KEY ("id")
);

-- Table reconciliation_details is MISSING
CREATE TABLE IF NOT EXISTS "reconciliation_details" (
  ...
  "remark" text,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "reconciliation_details_pkey" PRIMARY KEY ("id")
);

-- Table reconciliations is MISSING
...
-- Table statement_confirmation_details is MISSING
CREATE TABLE IF NOT EXISTS "statement_confirmation_details" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "dispute_reason" text,
  "created_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "statement_confirmation_details_pkey" PRIMARY KEY ("id")
);

-- Table statement_confirmations is MISSING
CREATE TABLE IF NOT EXISTS "statement_confirmations" (
  ...
  "created_at" timestamp with time zone DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "statement_confirmations_pkey" PRIMARY KEY ("id")
);

-- Table approval_delegations is MISSING
CREATE TABLE IF NOT EXISTS "approval_delegations" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  "delegator_id" uuid NOT NULL,
  "delegatee_id" uuid NOT NULL,
  "type" delegation_type DEFAULT 'GLOBAL',
  "flow_id" uuid,
...
-- Table approval_flows is MISSING
...
-- Table approval_nodes is MISSING
CREATE TABLE IF NOT EXISTS "approval_nodes" (
  ...
  "approver_mode" approval_node_mode DEFAULT 'ANY',
...
-- Table approval_tasks is MISSING
...
-- Table after_sales_tickets is MISSING
CREATE TABLE IF NOT EXISTS "after_sales_tickets" (
  ...
  "status" after_sales_status NOT NULL DEFAULT 'PENDING',
...
-- Table liability_notices is MISSING
CREATE TABLE IF NOT EXISTS "liability_notices" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "tenant_id" uuid NOT NULL,
  ...
  "status" liability_status NOT NULL DEFAULT 'DRAFT',
  ...
  "created_at" timestamp with time zone NOT NULL DEFAULT now(),
  "updated_at" timestamp with time zone DEFAULT now(),
  CONSTRAINT "liability_notices_pkey" PRIMARY KEY ("id")
);

-- Table audit_logs is MISSING
...
-- Table notification_preferences is MISSING
...
-- Table notification_queue is MISSING
...
-- Table notification_templates is MISSING
...
-- Table notifications is MISSING
...
-- Table system_announcements is MISSING
...
-- Table loyalty_transactions is MISSING
...
-- Table inventory_logs is MISSING
...
-- Table verification_codes is MISSING
...
-- Table worker_skills is MISSING
...
-- Table system_settings_history is MISSING
