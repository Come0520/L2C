...
Page({
    ...
    updateStateFromStore(store) {
        var _a, _b;
        const role = (store.currentRole || ((_a = store.userInfo) === null || _a === void 0 ? void 0 : _a.role) || 'guest').toLowerCase();
        this.setData({
            isLoggedIn: store.isLoggedIn,
            userInfo: store.userInfo,
            tenantStatus: ((_b = store.userInfo) === null || _b === void 0 ? void 0 : _b.tenantStatus) || '',
            role
        });
    },
    // =======================================
    ...
    callAdvisor() {
        ...
        if (!(advisor === null || advisor === void 0 ? void 0 : advisor.phone)) {
