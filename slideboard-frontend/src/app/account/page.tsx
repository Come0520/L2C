          ...
          <PaperCard.Content>
            <div className="text-center space-y-4">
              <div className="w-24 h-24 mx-auto bg-paper-primary-light rounded-full flex items-center justify-center">
                {profile.avatar ? (
                  <Image src={profile.avatar} alt="头像" width={96} height={96} className="w-full h-full rounded-full object-cover" />
                ) : (
          ...
          <PaperCard.Content>
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-paper-ink-secondary mb-1">邮箱</label>
                  {isEditing ? (
                    <input
                      type="email"
                    ...
                    <p className="text-paper-ink">{profile.email}</p>
                  )}
                </div>
                <div>
      ...
      <PaperCard>
        ...
        <PaperCard.Content>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-paper-ink">登录提醒</h4>
      ...
      <PaperCard>
        ...
        <PaperCard.Content>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-paper-ink">邮件通知</h4>
