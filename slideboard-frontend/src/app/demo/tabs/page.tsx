...
export default function TabsDemo() {
  const tabs = [
    ...
    },
    {
      ...
      value: "random",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-orange-700 to-yellow-900">
          <p>Random Tab</p>
          <DummyContent />
        </div>
      ),
  ...
  return (
    <div className="min-h-screen theme-warm bg-theme-bg-primary p-10">
...
const DummyContent = () => {
  return (
    <img
      src="https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=2652&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      alt="dummy image"
      width="1000"
      height="1000"
