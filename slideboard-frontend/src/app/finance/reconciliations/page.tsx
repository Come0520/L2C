                      ...
                      <PaperTableRow key={stmt.id}>
                        ...
                        <PaperTableCell>
                          <span className={`px-2 py-1 rounded text-sm ${
                            stmt.status === 'settled' ? 'bg-green-100 text-green-800' :
                            stmt.status === 'confirmed' ? 'bg-blue-100 text-blue-800' :
                        ...
                        <PaperTableCell>
                          <Link href={`/finance/reconciliations/${stmt.id}`} className="text-blue-600 hover:underline mr-2">详情</Link>
