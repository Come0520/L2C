...
export function PropertiesPanel({
  ...
  const handleElementStyleChange = (property: string, value: any) => {
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  type="number"
                  value={parseInt(selectedElementData.style.fontSize) || 16}
      ...
      <div className="border-b border-gray-200">
        <div className="flex">
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-medium border-b-2 ${activeTab === 'element'
          ...
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-medium border-b-2 ${activeTab === 'slide'
              ? 'border-primary-500 text-primary-600'
              : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
          >
