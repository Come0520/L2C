  ...
  return (
    <div className="space-y-6">
                        ...
                        {quote.confirmationDocument ? (
                          <>
                            ...
                            <PaperButton
                              ...
                              className="pr-8 max-w-xs truncate"
                            >
                              {quote.confirmationDocument.type === 'image' ? '📷' :
                                quote.confirmationDocument.type === 'pdf' ? '📄' : '📋'}
                              <span className="truncate">{quote.confirmationDocument.name}</span>
                            </PaperButton>
                              {/* 右上角删除按钮 - X图标 */}
                              <button
      ...
      >
        ...
        <PaperDialogFooter>
          <StatefulButton variant="outline" status="idle" onClick={() => setShowUploadDialog(false)}
          >
            取消
          </StatefulButton>
          <StatefulButton
