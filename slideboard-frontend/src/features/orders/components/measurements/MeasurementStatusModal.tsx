        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-2 pt-2">
              <StatefulButton variant="outline" status="idle" onClick={onClose} disabled={isUpdating}>
                取消
              </StatefulButton>
              <StatefulButton variant="primary" status={isUpdating ? "loading" : "idle"} onClick={handleUpdate} disabled={!newStatus}
              >
                {isUpdating ? '更新中...' : '确认更新'}
              </StatefulButton>
            </div>
