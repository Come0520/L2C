    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <PaperCard className="relative overflow-hidden group">
          ...
          <PaperCardContent className="p-6 relative z-10">
            <div className="flex flex-col">
              <p className="text-sm font-medium text-ink-500 mb-1">待推单数量</p>
              <div className="flex items-baseline gap-2">
                <h3 className="text-3xl font-bold text-ink-800">{orders.length}</h3>
                <span className="text-sm text-ink-400">单</span>
              </div>
              <p className="text-xs text-ink-400 mt-2">当前处于待推单状态的订单总数</p>
            </div>
          </PaperCardContent>
        </PaperCard>
        ...
        <PaperCard className="relative overflow-hidden group">
          ...
          <PaperCardContent className="p-6 relative z-10">
            <div className="flex flex-col">
              <p className="text-sm font-medium text-ink-500 mb-1">总确认金额</p>
              <div className="flex items-baseline gap-2">
                <h3 className="text-3xl font-bold text-ink-800">¥{orders.reduce((sum, order) => sum + order.confirmedAmount, 0).toLocaleString()}</h3>
              </div>
              <p className="text-xs text-ink-400 mt-2">所有待推单订单的确认总金额</p>
            </div>
          </PaperCardContent>
        </PaperCard>
      </div>
      ...
      <PaperCard className="backdrop-blur-xl bg-white/80 dark:bg-neutral-900/80 border border-white/20 shadow-xl ring-1 ring-black/5 dark:ring-white/10">
        <PaperTableToolbar className="border-b border-black/5 dark:border-white/5 bg-transparent px-6 py-4 flex justify-between items-center">
          <div className="text-sm font-medium text-ink-600">共 {orders.length} 条待推单</div>
        </PaperTableToolbar>
