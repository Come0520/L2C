...
export default function AuthError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="border-border bg-card w-full max-w-md space-y-6 rounded-lg border p-6 text-center shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-secondary/50 text-secondary-foreground rounded-md p-3 text-left text-sm">
            <p className="mb-1 font-medium">建议的解决步骤：</p>
