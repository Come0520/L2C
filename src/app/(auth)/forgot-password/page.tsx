...
export default function ForgotPasswordPage() {
  ...
  if (isSuccess) {
    return (
      <div className="shadow-input mx-auto w-full max-w-md rounded-2xl border border-white/20 bg-white/10 p-8 backdrop-blur-xl transition-all duration-300 dark:bg-black/40">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/login"
            className="text-primary-500 hover:text-primary-600 dark:text-primary-400 flex items-center text-sm font-medium transition-colors"
          >
  ...
  return (
    ...
    >
      <div className="mb-6">
        <Link
          href="/login"
          className="inline-flex items-center text-sm text-neutral-500 transition-colors hover:text-neutral-700 dark:hover:text-neutral-300"
        >
