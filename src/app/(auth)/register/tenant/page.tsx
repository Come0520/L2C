                    ...
                    <CardContent className="space-y-4">
                        <div className="bg-white/5 rounded-lg p-4 text-center">
                            <p className="text-slate-300 text-sm">
                                我们将在 <span className="text-white font-semibold">1-3 个工作日</span> 内完成审核
                            </p>
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 py-8">
            <Card className="w-full max-w-lg bg-white/10 backdrop-blur-xl border-white/20">
                <CardHeader className="text-center">
                    <div className="mx-auto w-16 h-16 rounded-full bg-blue-500/20 flex items-center justify-center mb-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="bg-white/5 border-white/20 text-white placeholder:text-slate-500 min-h-[80px]"
                            />
                        </div>
