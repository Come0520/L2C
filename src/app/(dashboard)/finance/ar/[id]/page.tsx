...
export default async function ARStatementDetailPage({
  params,
}: {
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {(statement.status as string) !== 'PAID' &&
            (statement.status as string) !== 'CANCELLED' && (
              <ReceiptBillDialog
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base">
                  {statement.customerName || statement.customer?.name || '-'}
                </p>
              </div>
              <div>
              ...
              <TableBody>
                {statement.commissionRecords.map((record: any) => (
                  <TableRow key={record.id}>
                    ...
                    <TableCell>
                      {format(new Date(record.calculatedAt), 'yyyy-MM-dd HH:mm')}
                    </TableCell>
