    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">供应商扣款、退货管理</p>
        </div>
        <Button>
      ...
      {notes.length === 0 ? (
        ...
        <div className="rounded-md border">
          <table className="w-full">
            ...
            <tbody>
              {notes.map((note) => (
                <tr key={note.id} className="hover:bg-muted/30 border-t">
                  ...
                  <td className="text-muted-foreground max-w-[200px] truncate p-3 text-sm">
                    {note.reason}
                  </td>
