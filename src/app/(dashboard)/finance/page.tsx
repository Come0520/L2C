...
function getUserFinancePermissions(roles: string[]): Set<string> {
    ...
    for (const roleCode of roles) {
        ...
        if (roleCode === 'ADMIN' || roleCode === 'TENANT_ADMIN') {
            return new Set([
                'finance.ar.view', 'finance.ar.create', 'finance.ar.reconcile',
                'finance.ap.view', 'finance.ap.create', 'finance.ap.reconcile',
                'finance.approve', 'finance.review',
                ...
                'finance.config.manage', 'finance.labor_view',
            ]);
        }
...
function ActionCard({
    ...
    return (
        <Link href={href}>
            <Card className="group hover:shadow-md transition-all cursor-pointer h-full border-transparent hover:border-border">
...
function QuickLink({
    ...
    return (
        <Link href={href}>
            <Card className="group hover:shadow-sm transition-all cursor-pointer hover:bg-accent/50">
