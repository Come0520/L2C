              ...
              <div>
                ...
                <p className="text-base">
                  ...
                  {reconciliation.createdAt
                    ? format(new Date(reconciliation.createdAt), 'yyyy-MM')
                    : '-'}
                </p>
              </div>
              <div>
                ...
                <p className="text-base">
                  {reconciliation.createdAt
                    ? format(new Date(reconciliation.createdAt), 'yyyy-MM-dd HH:mm')
                    : '-'}
                </p>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between border-b py-2">
              ...
              <span
                className={`text-lg font-semibold ${Number(reconciliation.unmatchedAmount || 0) !== 0 ? 'text-red-600' : 'text-green-600'}`}
              >
                ...
                {reconciliation.details.map(
                  (detail: {
                    ...
                    <TableRow key={detail.id}>
                      ...
                      <TableCell
                        className={Number(detail.difference) !== 0 ? 'font-bold text-red-500' : ''}
                      >
