...
async function CashFlowContent({
  ...
  return <CashFlowClient data={data} initialStartDate={rawStart} initialEndDate={rawEnd} />;
}
...
export default async function CashFlowPage({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-6">
      ...
      <Suspense
        fallback={
          <div data-loading="true" className="bg-muted h-96 w-full animate-pulse rounded-lg" />
        }
      >
        <CashFlowContent
          tenantId={tenantId}
