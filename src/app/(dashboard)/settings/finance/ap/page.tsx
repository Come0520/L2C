...
import { Wallet, Users, Truck, Gift } from 'lucide-react';
 ...
 */
export default function APConfigPage() {
    // 预存模式配置
    const [prepaidBonusType, setPrepaidBonusType] = useState('BALANCE');
    const [prepaidBonusRatio, setPrepaidBonusRatio] = useState(10);
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                <Label>赠送方式</Label>
                                <Select value={prepaidBonusType} onValueChange={setPrepaidBonusType}>
