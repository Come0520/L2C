...
import { updateARPaymentConfig, type ARPaymentConfig } from '@/features/settings/actions/tenant-config';
...
export function ARConfigForm({ initialConfig }: ARConfigFormProps) {
    ...
    const [requireDebtApproval, setRequireDebtApproval] = useState(initialConfig.requireDebtInstallApproval);
                ...
                <CardContent className="space-y-6">
                    ...
                    {enableInstallment && (
                        <>
                            ...
                            <div className="space-y-2">
                                <Label>定金计算规则</Label>
                                <Select value={depositCalcRule} onValueChange={(v) => setDepositCalcRule(v as typeof depositCalcRule)}>
