...
export default function RemindersPage() {
  return (
    <div className="space-y-6">
      <DashboardPageHeader title="提醒设置" subtitle="配置系统通知和提醒规则" />
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                ...
                <div className="text-muted-foreground text-sm">当报价单超过3天未跟进时提醒销售</div>
              </div>
            ...
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                ...
                <div className="text-muted-foreground text-sm">当应收到期前1天和逾期后提醒财务</div>
              </div>
