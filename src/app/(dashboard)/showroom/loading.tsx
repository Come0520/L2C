...
export default function Loading() {
  return (
    <div className="h-[calc(100vh-8rem)] space-y-4 p-6">
      {/* Header Skeleton */}
      ...
      <div className="glass-liquid-ultra w-full flex-1 space-y-6 rounded-2xl border border-white/10 p-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div key={i} className="space-y-3 rounded-xl border border-white/5 bg-white/5 p-4">
