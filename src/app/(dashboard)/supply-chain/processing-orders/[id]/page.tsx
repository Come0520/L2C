          ...
          <Card>
            ...
            <CardContent>
                ...
                {po.items.map((item: any) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      {item.unitFee && (
                        <div className="text-muted-foreground text-sm">¥{item.unitFee} / 个</div>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-lg font-bold">¥{po.actualFee || '-'}</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {shipments.length > 0 ? (
                ...
                <div className="text-muted-foreground py-4 text-center">暂无关联物流</div>
              )}
            </CardContent>
          </Card>
        </div>
