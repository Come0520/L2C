      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">未设置</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
              ...
              {!productData.logs || productData.logs.length === 0 ? (
                ...
                <div className="space-y-3">
                  {productData.logs.map((log: Log) => (
                    <div key={log.id} className="space-y-1 rounded-lg bg-gray-50 p-3">
                      ...
                      <div className="text-xs text-gray-500">操作人 ID: {log.userId}</div>
                      {Object.keys((log.changedFields as Record<string, unknown>) || {}).length >
                        0 && (
          ...
          {false &&
            ...
            (productData as any).images.length > 0 && (
              <Card>
                <CardHeader>
