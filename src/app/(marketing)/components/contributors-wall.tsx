...
const contributors: Contributor[] = [
  {
    ...
    name: '聂老师',
    role: '业务架构师',
    contribution: '提出云展厅 2.1 优化方案，持续打磨业财一体化深度逻辑。',
    avatarColor: '#F97316',
    verified: true,
  },
  {
    ...
    name: '一枝花',
    role: '安全卫士',
    contribution: '深度参与密码找回系统重构，精准识别并修复落地页多项交互缺陷。',
    avatarColor: '#10B981',
    verified: true,
  },
  {
    ...
    name: 'Antigravity',
    role: 'AI 联创',
    contribution: '攻克多租户架构切换核心难题，实现全业务 L4 级成熟度升级。',
    avatarColor: '#14B8A6',
    verified: true,
  },
  {
    ...
    name: '安琪',
    role: '质量卫士',
    contribution: '持续追踪报价单关键缺陷，保障算价引擎在多租户环境下的准确性。',
    avatarColor: '#EC4899',
    verified: true,
  },
];
