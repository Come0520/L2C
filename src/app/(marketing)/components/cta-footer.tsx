    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10">
          ...
          <div className="absolute -right-32 -bottom-32 h-96 w-96 rounded-full bg-indigo-600/20 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            >
              {/* 呼吸光效 */}
              <span className="absolute inset-0 animate-pulse rounded-xl bg-blue-400/20" />
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li className="text-sm text-gray-500">邮箱：contact@l2c.com</li>
                <li className="text-sm text-gray-500">微信：L2C-Service</li>
              </ul>
            </div>
          </div>
