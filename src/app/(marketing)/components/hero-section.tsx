      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-2xl">
            <h1
              className={cn(
                'text-4xl leading-tight font-bold tracking-tight text-gray-900 transition-all duration-700 sm:text-5xl lg:text-6xl',
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-gray-200/60 bg-gradient-to-br from-gray-50 to-white p-8 shadow-xl sm:p-10">
              ...
              <div key={slide.id} className="animate-fade-in space-y-4">
                ...
                <p className="leading-relaxed text-gray-600">{slide.subtitle}</p>
                {slide.cta && (
                  <Link
                    href={slide.cta.href}
              ...
              <div className="mt-8 flex items-center justify-between">
                  ...
                  {heroCarouselItems.map((_, i) => (
                    <button
                      ...
                      className={cn(
                        ...
                        i === currentSlide ? 'w-8 bg-blue-600' : 'w-4 bg-gray-300 hover:bg-gray-400'
                      )}
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() =>
                      setCurrentSlide(
                        (prev) => (prev - 1 + heroCarouselItems.length) % heroCarouselItems.length
                      )
                    }
