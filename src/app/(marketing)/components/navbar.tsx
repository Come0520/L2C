  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? 'border-b border-gray-200/50 bg-white/80 shadow-sm backdrop-blur-xl'
          : 'bg-transparent'
      )}
    >
          ...
          <div className="hidden items-center gap-3 md:flex">
            {isLoggedIn ? (
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-blue-700 hover:shadow-md"
              >
