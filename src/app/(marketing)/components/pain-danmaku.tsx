    ...
    return (
        ...
        >
                        ...
                        >
                            ...
                            {[...trackItems, ...trackItems].map((item, i) => (
                                <button
                                    ...
                                    className={cn(
                                        'whitespace-nowrap rounded-full border px-5 py-2.5 text-sm font-medium transition-all duration-200',
            ...
            {selectedPain && (
                ...
                >
                    <div
                        className="relative w-full max-w-lg animate-scale-in rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl"
