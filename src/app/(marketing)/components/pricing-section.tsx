                ...
                <div className="mb-16 text-center">
                    ...
                    <p className="mt-4 text-xl text-gray-500">
                        ...
                        <span className="relative inline-block font-bold text-blue-600">
                            永久免费
                            {/* Shimmer 效果 */}
                            <span className="pointer-events-none absolute inset-0 -skew-x-12 animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
                        </span>
                    </p>
                </div>
                    ...
                    {pricingPlans.map((plan) => (
                        <div
                            ...
                            className={cn(
                                ...
                                plan.highlighted
                                    ? 'border-blue-200 bg-white ring-2 ring-blue-600 shadow-lg'
