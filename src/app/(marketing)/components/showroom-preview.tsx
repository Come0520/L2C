              ...
              <div className="rounded-2xl border border-gray-200 bg-gray-100 p-2 shadow-xl">
                ...
                <div className="flex aspect-[16/10] items-center justify-center rounded-lg bg-white">
                  <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">云展厅界面预览</p>
                  </div>
                </div>
              </div>

              {/* 手机设备（右下角叠加） */}
              <div className="absolute -right-4 -bottom-6 w-28 rounded-xl border border-gray-200 bg-gray-100 p-1 shadow-lg sm:w-32">
