  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2
          className={cn(
            'text-4xl leading-tight font-bold tracking-tight text-gray-900 transition-all duration-1000 sm:text-5xl lg:text-7xl',
            isInView ? 'blur-0 translate-y-0 opacity-100' : 'translate-y-8 opacity-0 blur-lg'
          )}
        >
          让窗帘生意变得
        ...
        <p
          className={cn(
            ...
            isInView ? 'blur-0 translate-y-0 opacity-100' : 'translate-y-8 opacity-0 blur-md'
          )}
        >
          从线索到收款，一气呵成
        </p>
        ...
        >
          {[
            ...
            <div key={item.label} className="text-center">
              <div className="text-3xl font-bold text-blue-600 sm:text-4xl">{item.value}</div>
