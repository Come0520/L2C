    ...
    <div className="mx-auto max-w-5xl space-y-8 p-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Card className="space-y-4 p-6">
          <h2 className="flex items-center gap-2 text-lg font-semibold">Excel 导出</h2>
          <p className="text-muted-foreground text-sm">
            测试通用 Excel 导出按钮，支持自动表头映射和 Loading 状态。
          </p>
          {}
          <ExcelExportButton data={mockData} columns={columns as any} filename="订单列表导出" />
        </Card>

        {/* PDF 导出测试 */}
        <Card className="space-y-4 p-6">
          <h2 className="flex items-center gap-2 text-lg font-semibold">PDF 导出</h2>
          <p className="text-muted-foreground text-sm">
      ...
      <Card className="space-y-4 p-6">
        ...
        <div className="bg-muted h-[600px] overflow-hidden rounded-md border">
