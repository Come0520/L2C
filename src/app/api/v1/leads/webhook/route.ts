...
export async function POST(request: NextRequest) {
  try {
    ...
    let systemUserId =
      typeof tenantSettings.webhookUserId === 'string' ? tenantSettings.webhookUserId : undefined;
      ...
      return NextResponse.json(
        {
          code: 500,
          message:
            'Configuration Error: No admin user found for tenant. Configure webhookUserId in tenant settings.',
        },
        { status: 500 }
      );
    }
