...
import {
  getDeductionLedger,
  checkDeductionAllowed,
  getAllDeductionLedgers,
  DEDUCTION_SAFETY_CONFIG,
} from '../logic/deduction-safety';
...
describe('Deduction Safety Logic (Optimized)', () => {
  ...
  describe('getAllDeductionLedgers', () => {
    it('should batch process multiple ledgers efficiently', async () => {
      ...
      (db.query.suppliers.findMany as any).mockResolvedValue([
        { id: 'fact-1', name: 'Supplier 1' },
      ]);
