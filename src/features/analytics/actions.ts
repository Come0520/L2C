...
import { eq, and, gte, lte, sql, desc, SQL, notInArray } from 'drizzle-orm';
...
const getDashboardStatsAction = createSafeAction(dashboardStatsSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        async () => {
            ...
            if (salesId) {
                leadConditions.push(eq(leads.assignedSalesId, salesId));
            }
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-dashboard'],
            revalidate: 3600
        }
...
const getSalesFunnelAction = createSafeAction(salesFunnelSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-funnel'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getLeaderboardAction = createSafeAction(leaderboardSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-leaderboard'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getOrderTrendAction = createSafeAction(orderTrendSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-trend'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getDeliveryEfficiencyAction = createSafeAction(deliveryEfficiencySchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-delivery'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getCustomerSourceDistributionAction = createSafeAction(customerSourceSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-source'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getProfitMarginAnalysisAction = createSafeAction(profitMarginSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-profit'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getAfterSalesHealthAction = createSafeAction(afterSalesHealthSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-after-sales'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getCashFlowForecastAction = createSafeAction(cashFlowForecastSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-cashflow'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getARAgingAnalysisAction = createSafeAction(arAgingAnalysisSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-ar'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
...
const getPricingReferenceAction = createSafeAction(pricingReferenceSchema, async (params, { session }) => {
    ...
    return unstable_cache(
        ...
        {
            tags: [`analytics-${tenantId}`, 'analytics-pricing'],
            revalidate: 3600
        }
    )().then(data => ({ success: true, data }));
});
