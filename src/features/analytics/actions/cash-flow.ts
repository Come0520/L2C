 ...
 */
const getCashFlowForecastAction = createSafeAction(
    ...
    return unstable_cache(
      async () => {
        ...
        try {
          ...
          const [weeklyForecast, monthlyForecast, overduePayments, byScheduleType] =
            await Promise.all([
              db
                .select({
          ...
          const totalForecast = weeklyForecast.reduce(
