 ...
 */
const getDashboardStatsAction = createSafeAction(
    ...
    return unstable_cache(
      async () => {
        ...
        try {
          ...
          logger.info('获取仪表盘核心统计数据成功 (Successfully fetched dashboard stats)', {
            tenantId,
          });
          ...
          logger.error('获取仪表盘核心统计数据失败 (Failed to fetch dashboard stats)', {
            tenantId,
            error,
          });
