  ...
  return (
    <Card className={cn('overflow-hidden', className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={cn(
                'font-medium',
                measureOnTimeRate >= 90
                  ? 'text-green-600'
                  : measureOnTimeRate >= 70
                    ? 'text-yellow-600'
                    : 'text-red-600'
              )}
            >
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={cn(
                'font-medium',
                installOnTimeRate >= 90
                  ? 'text-green-600'
                  : installOnTimeRate >= 70
                    ? 'text-yellow-600'
                    : 'text-red-600'
              )}
            >
        ...
        {hasOverdue && (
          <div className="flex items-center justify-between rounded-md bg-red-50 px-3 py-2 text-red-600 dark:bg-red-900/20">
            <div className="flex items-center gap-2">
        ...
        {!hasOverdue && (
          <div className="flex items-center justify-between rounded-md bg-green-50 px-3 py-2 text-green-600 dark:bg-green-900/20">
            <div className="flex items-center gap-2">
