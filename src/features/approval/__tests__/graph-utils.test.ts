...
describe('Graph Utils - flattenApprovalGraph', () => {
  ...
  it('should flatten a simple linear graph', () => {
    ...
    const edges: ApprovalEdge[] = [{ id: 'e1', source: 'start', target: 'node1', type: 'default' }];
  ...
  it('should parse various operators correctly', () => {
    const nodes: ApprovalNode[] = [
      ...
      },
      {
        ...
        type: 'condition',
        position: { x: 50, y: 0 },
        data: { label: 'C1', condition: 'a == 1' },
      },
      {
        id: 'c2',
        type: 'condition',
        position: { x: 100, y: 0 },
        data: { label: 'C2', condition: 'b >= 2' },
      },
      {
        id: 'c3',
        type: 'condition',
        position: { x: 150, y: 0 },
        data: { label: 'C3', condition: 'c != 3' },
      },
