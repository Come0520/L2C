            ...
            <div className="flex items-center gap-2">
              <span
                className={cn(
                  ...
                  selectedChannel.level === 'S'
                    ? 'bg-yellow-500'
                    : selectedChannel.level === 'A'
                      ? 'bg-green-500'
                      : selectedChannel.level === 'B'
                        ? 'bg-blue-500'
                        : 'bg-gray-400'
                )}
              />
              ...
              {filteredChannels.map((channel) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {value === channel.id && <Check className="text-primary h-4 w-4" />}
                  </div>
                </CommandItem>
              ))}
            </CommandGroup>
