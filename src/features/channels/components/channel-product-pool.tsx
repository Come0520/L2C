...
import { updateProductChannelPrice, removeFromChannelPool } from '../actions/channel-products';
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>管理可供渠道分销的商品及其底价</CardDescription>
        </div>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="max-h-[80vh] max-w-2xl overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>选择商品并设置渠道底价</DialogDescription>
            </DialogHeader>
      ...
      <CardContent>
        {channelProducts.length === 0 ? (
          <div className="text-muted-foreground py-12 text-center">尚未添加任何渠道商品</div>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
