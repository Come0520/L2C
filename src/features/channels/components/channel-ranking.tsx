      ...
      <CardContent>
        {data.length === 0 ? (
          <div className="text-muted-foreground flex flex-col items-center justify-center py-12">
            ...
            <p className="px-4 text-center text-xs">尝试调整时间范围或在渠道管理中激活更多渠道</p>
          </div>
        ) : (
    ...
    <div>
      <div
        className={cn(
          ...
          isChild && 'border-muted ml-8 border-l-2'
        )}
      ...
      >
        ...
        <div className="flex items-center gap-6 text-sm">
          <div className="text-right">
            ...
            <div className="text-muted-foreground text-xs">带单</div>
          </div>
          <div className="text-right">
            <div className="font-medium">{channel.dealCount}单</div>
            <div className="text-muted-foreground text-xs">成交</div>
          </div>
          <div className="text-right">
            <div className="font-medium">{channel.conversionRate.toFixed(0)}%</div>
            <div className="text-muted-foreground text-xs">转化</div>
          </div>
        </div>
      </div>
