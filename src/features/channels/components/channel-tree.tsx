...
export function ChannelTree({ initialData, categoryTypes, tenantId }: ChannelTreeProps) {
  ...
  return (
    <div className="relative flex h-[calc(100vh-8rem)] w-full flex-col perspective-[1000px]">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <Input
                ...
                className="bg-background/50 h-9 w-[250px] pl-9"
              />
            </div>
...
function ChannelTreeNode({
  ...
  return (
    <div>
      <div
        className={cn(
          'hover:bg-muted/50 flex items-center gap-2 rounded-lg p-3 transition-colors',
        ...
        <div className="flex flex-1 items-center gap-4">
          ...
          <div className="flex min-w-[200px] items-center gap-2">
            ...
            <div>
              ...
              <div className="text-muted-foreground text-xs">{channel.channelNo}</div>
            </div>
          </div>
          ...
          {/* 联系人 */}
          <div className="text-muted-foreground flex min-w-[120px] items-center gap-1 text-sm">
          ...
          <div className="text-muted-foreground flex min-w-[120px] items-center gap-1 text-sm">
            ...
            <span>
              {channel.phone ? `${channel.phone.slice(0, 3)}****${channel.phone.slice(-4)}` : '-'}
            </span>
          </div>

          {/* 业绩 */}
          <div className="flex min-w-[100px] items-center gap-1 text-sm">
