    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {fields.map((field, index) => (
          <div key={field.id} className="bg-muted/50 flex items-end gap-3 rounded-lg p-3">
            <FormField
              control={form.control}
            ...
            />
            <div className="text-muted-foreground pb-3">至</div>
            <FormField
              control={form.control}
            ...
            />
            <div className="text-muted-foreground pb-3">返点</div>
            <FormField
              control={form.control}
