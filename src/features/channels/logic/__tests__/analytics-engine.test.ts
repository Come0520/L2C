...
describe('Channels Analytics Engine (渠道分析计算引擎测试)', () => {
  it('应该正确合并数据并计算 KPI', () => {
    const channels = [{ id: 'ch-1', name: '渠道A', totalLeads: 100, totalDealAmount: 10000 }];
    const commissions = [{ channelId: 'ch-1', totalCommission: 1000, orderCount: 10 }];
  ...
  it('当佣金为 0 时，ROI 应返回 0', () => {
    const channels = [{ id: 'ch-2', name: '渠道B', totalLeads: 10, totalDealAmount: 500 }];
