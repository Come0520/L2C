...
export function CustomerForm({ onSuccess, tenantId, initialData }: CustomerFormProps) {
  ...
  // 兼容旧数据：纯数字电话号码自动补 +86 前缀，满足 E.164 格式
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      phoneSecondary: normalizePhone(initialData?.phoneSecondary) || undefined,
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <PhoneInput placeholder="输入11位手机号" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <PhoneInput placeholder="选填" {...field} value={field.value || ''} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
