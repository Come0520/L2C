...
export const customerLifecycleStages = ['LEAD', 'OPPORTUNITY', 'SIGNED', 'DELIVERED', 'LOST'] as const;
export const customerPipelineStatuses = ['UNASSIGNED', 'PENDING_FOLLOWUP', 'PENDING_MEASUREMENT', 'PENDING_QUOTE', 'QUOTE_SENT', 'IN_PRODUCTION', 'PENDING_DELIVERY', 'PENDING_INSTALLATION', 'COMPLETED'] as const;
