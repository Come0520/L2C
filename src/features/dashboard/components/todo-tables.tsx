...
export const TodoCategoryTable = React.memo(function TodoCategoryTable({
  ...
  switch (category) {
    case 'LEAD':
      return (
        <LeadTable items={data.leads || []} actionLoading={actionLoading} onAction={onAction} />
      );
    case 'ORDER':
      return (
        <OrderTable items={data.orders || []} actionLoading={actionLoading} onAction={onAction} />
      );
    case 'PO':
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            <th className="p-3 text-left font-medium">线索编号</th>
            <th className="p-3 text-left font-medium">客户名称</th>
            <th className="p-3 text-left font-medium">电话</th>
            <th className="p-3 text-left font-medium">意向等级</th>
              ...
              <td className="p-3 text-right">
                <div className="flex items-center justify-end gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      onAction(() => convertLead({ leadId: item.id }), item.id, 'LEAD')
                    }
                  >
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            ...
            <th className="p-3 text-left font-medium">客户名称</th>
            <th className="p-3 text-left font-medium">金额</th>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            <th className="p-3 text-left font-medium">采购单号</th>
            <th className="p-3 text-left font-medium">供应商</th>
            <th className="p-3 text-left font-medium">金额</th>
            <th className="p-3 text-left font-medium">状态</th>
            <th className="p-3 text-left font-medium">创建时间</th>
          </tr>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            <th className="p-3 text-left font-medium">任务编号</th>
            <th className="p-3 text-left font-medium">车间</th>
            <th className="p-3 text-left font-medium">状态</th>
            <th className="p-3 text-left font-medium">创建时间</th>
          </tr>
        </thead>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            <th className="p-3 text-left font-medium">工单号</th>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="text-muted-foreground border-b border-white/10">
            <th className="p-3 text-left font-medium">审批 ID</th>
            <th className="p-3 text-left font-medium">业务类型</th>
            <th className="p-3 text-left font-medium">状态</th>
            <th className="p-3 text-left font-medium">超时时间</th>
            <th className="p-3 text-left font-medium">创建时间</th>
          </tr>
        </thead>
        <tbody>
          {items.map((item) => (
            ...
            >
              ...
              <td className="p-3">
                <Badge variant="secondary" className="bg-orange-500/10 text-xs text-orange-500">
                  待审批
                </Badge>
              </td>
              <td className="text-muted-foreground p-3 text-xs">
