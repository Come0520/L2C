...
export function EnhancedFunnelWidget({ className }: EnhancedFunnelWidgetProps) {
  const { data: swrData, isLoading } = useSWR('/api/workbench/sales-funnel', fetcher, {
  ...
  return <SalesFunnelChart data={data.stages} summary={data.summary} className={className} />;
}
