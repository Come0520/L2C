        ...
        <Card>
          ...
          <CardContent className="space-y-4">
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>是否允许结案时存在未结清的微小差额</FormDescription>
                  </div>
                  <FormControl>
            ...
            {form.watch('allow_difference') && (
              <div className="border-primary/20 grid grid-cols-2 gap-4 border-l-2 pl-4">
                <FormField
                  control={form.control}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>在生成应收/应付对账单时自动应用抹零</FormDescription>
                  </div>
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
