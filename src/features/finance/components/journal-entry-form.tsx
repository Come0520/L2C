...
export function JournalEntryForm({ accountOptions, periodOptions, onSuccess }: JournalEntryFormProps) {
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                                                ...
                                                <FormItem>
                                                    <FormControl>
                                                        <Input
                                                            ...
                                                            {...f}
                                                            onChange={(e: any) => f.onChange(e.target.value === '' ? 0 : Number(e.target.value))}
                                                        />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                            ...
                            {/* 合计栏 */}
                            <div className="grid grid-cols-12 gap-2 text-sm font-medium pt-4 border-t">
                                <div className="col-span-7 text-right pr-4">合计:</div>
                                <div className={`col-span-2 text-right ${!isBalanced && totalDebit.gt(0) ? 'text-destructive' : ''}`}>
                                    {totalDebit.toFixed(2)}
                                </div>
                                <div className={`col-span-2 text-right ${!isBalanced && totalCredit.gt(0) ? 'text-destructive' : ''}`}>
                                    {totalCredit.toFixed(2)}
                                </div>
                                <div className="col-span-1"></div>
                            </div>
                            {!isBalanced && (totalDebit.gt(0) || totalCredit.gt(0)) && (
                                <p className="text-sm font-medium text-destructive text-right pr-6 mt-1">
