                    ...
                    {initialData.length === 0 ? (
                        ...
                        initialData.map((period) => (
                            <TableRow key={period.id}>
                                ...
                                <TableCell>
                                    {period.status === 'OPEN' ? (
                                        <Badge variant="outline" className="border-green-500 text-green-600 bg-green-50">进行中</Badge>
                                    ) : (
                                        <Badge variant="secondary" className="flex items-center w-fit gap-1 bg-gray-100"><Lock size={12} />已关闭</Badge>
                                    )}
                                </TableCell>
