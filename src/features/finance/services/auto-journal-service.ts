...
export async function generateAutoJournal(params: {
    ...
    const lines = [
        { accountId: template.debitAccountId, debitAmount: amount, creditAmount: '0', description: `${description} - 借方` },
        { accountId: template.creditAccountId, debitAmount: '0', creditAmount: amount, description: `${description} - 贷方` }
    ];
