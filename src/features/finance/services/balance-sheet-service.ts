 ...
 */
export async function getBalanceSheetData(tenantId: string, asOfDate: Date): Promise<BalanceSheetData> {
    ...
    const roundingDiff = Math.abs(result.assets.total - (result.liabilities.total + result.equity.total));
