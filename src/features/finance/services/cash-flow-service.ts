 ...
 */
export async function getCashFlowData(tenantId: string, startDate: Date, endDate: Date): Promise<CashFlowData> {
    ...
    const result: CashFlowData = {
        ...
        operatingActivities: { inflows: [], totalInflow: 0, outflows: [], totalOutflow: 0, netCashFlow: 0 },
        netIncrease: 0,
    };
    ...
    // 计算净额
    result.operatingActivities.netCashFlow = result.operatingActivities.totalInflow - result.operatingActivities.totalOutflow;
    result.netIncrease = result.operatingActivities.netCashFlow;

    // 保留两位小数
    result.operatingActivities.totalInflow = Number(result.operatingActivities.totalInflow.toFixed(2));
    result.operatingActivities.totalOutflow = Number(result.operatingActivities.totalOutflow.toFixed(2));
    result.operatingActivities.netCashFlow = Number(result.operatingActivities.netCashFlow.toFixed(2));
