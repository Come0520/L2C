...
vi.mock('@/shared/config/permissions', () => ({
  PERMISSIONS: {
    LEAD: {
      OWN_EDIT: 'lead.own.edit', // 替代废弃的 CREATE 和 EDIT
      OWN_VIEW: 'lead.own.view',
      ALL_EDIT: 'lead.all.edit',
      ALL_VIEW: 'lead.all.view',
      ASSIGN: 'lead.assign',
      TRANSFER: 'lead.transfer',
      DELETE: 'lead.delete',
      IMPORT: 'lead.import',
      POOL_VIEW: 'lead.pool.view', // 公海可见
      RESTORE: 'lead.restore', // 恢复作废
    },
  },
}));
