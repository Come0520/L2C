...
export class WeChatAdapter implements ChannelAdapter {
  ...
  private readonly DEFAULT_MINI_TEMPLATE_ID =
    process.env.WECHAT_MINI_TEMPLATE_ID || 'DEFAULT_MINI_TEMPLATE';
  private readonly DEFAULT_OFFICIAL_TEMPLATE_ID =
    process.env.WECHAT_OFFICIAL_TEMPLATE_ID || 'DEFAULT_OFFICIAL_TEMPLATE';
