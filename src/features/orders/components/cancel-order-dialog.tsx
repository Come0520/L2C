...
export function CancelOrderDialog({
  ...
  // 检查是否允许撤单
  const canCancel = CANCELABLE_STATUSES.includes(
    orderStatus as (typeof CANCELABLE_STATUSES)[number]
  );
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[450px]">
        <DialogHeader>
          ...
          <DialogDescription>
            您正在申请撤销订单 <span className="text-foreground font-bold">{orderNo}</span>
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="reason">
              撤单原因 <span className="text-red-500">*</span>
            </Label>
            <Select
              value={reason}
