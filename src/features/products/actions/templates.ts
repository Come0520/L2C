 ...
 */
const upsertAttributeTemplateActionInternal = createSafeAction(
  templateSchemaZod,
  async (data, { session }) => {
 ...
 */
const getAttributeTemplateActionInternal = createSafeAction(
  getTemplateSchemaZod,
  async ({ category }, { session }) => {
