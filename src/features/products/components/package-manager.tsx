...
import { getPackages, deletePackage, togglePackageStatus } from '../actions/package-actions';
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-muted-foreground py-8 text-center">暂无套餐数据</div>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                {filteredPackages.map((pkg) => (
                  <TableRow key={pkg.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline">{getPackageTypeLabel(pkg.packageType)}</Badge>
                    </TableCell>
      ...
      <PackageFormDialog
        ...
        editingData={
          editingPackage as React.ComponentProps<typeof PackageFormDialog>['editingData']
        }
