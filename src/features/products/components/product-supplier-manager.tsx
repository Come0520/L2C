...
export function ProductSupplierManager({ productId }: ProductSupplierManagerProps) {
  ...
  }, [productId, fetchProductSuppliers, loadAllSuppliers]);
                        ...
                        <SelectContent>
                          {allSuppliers.map((s) => (
                            <SelectItem
                              key={s.id}
                              value={s.id}
                              disabled={suppliers.some((ps) => ps.supplierId === s.id)}
                            >
                              {s.name}
                            </SelectItem>
                          ))}
                  ...
                  <TableCell>
                    {item.isDefault ? (
                      ...
                      <Button
                        ...
                        className="text-muted-foreground hover:text-primary h-6 text-xs"
                      >
                        设为默认
                      </Button>
                    )}
