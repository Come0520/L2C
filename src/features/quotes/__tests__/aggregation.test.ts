  ...
  const mockTx = {
    query: {
      ...
      tenants: {
        findFirst: vi
          .fn()
          .mockResolvedValue({ id: '3310086c-0e86-4b2a-aecf-366b57954930', settings: {} }),
      },
    },
    insert: vi.fn(() => ({
      values: vi.fn(() => ({
...
vi.mock('../actions', () => ({
  createQuoteBundle: vi
    .fn()
    .mockResolvedValue({ success: true, data: { id: 'c9120bc7-0812-4c92-adfb-29837126c810' } }),
  getQuoteBundleById: vi.fn().mockImplementation(async ({ id }) => {
    ...
    return {
      ...
      data: {
        id,
        totalAmount: global.__BUNDLE_TOTAL__ || '0',
        finalAmount: global.__BUNDLE_TOTAL__ || '0',
      },
    };
  }),
  createQuote: vi
    .fn()
    .mockResolvedValue({ success: true, data: { id: 'd019bc2a-0a19-482c-9a2c-12938174c0b2' } }),
