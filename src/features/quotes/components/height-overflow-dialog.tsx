    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>成品高度超过面料可用高度，请选择一种解决方案</DialogDescription>
        </DialogHeader>
            ...
            return (
              ...
              >
                ...
                {solution.recommended && (
                  <Badge className="absolute -top-2 right-4 bg-green-500">推荐</Badge>
                )}
                ...
                <div className="mt-3 grid grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p
                      className={`font-medium ${priceDiff > 0 ? 'text-red-500' : 'text-green-500'}`}
                    >
                      {priceDiff > 0 ? '+' : ''}
                      {priceDiff.toFixed(0)} 元
                    </p>
                  </div>
                </div>
              </div>
