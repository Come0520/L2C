  ...
  return (
    <div
      className={cn(
        ...
        // 背景样式 - 毛玻璃效果
        'bg-background/95 border-t shadow-lg backdrop-blur-md',
        // 安全区域适配（移动端）
        'pb-safe',
        className
      )}
    >
      ...
      {isExpanded && hasBreakdown && (
        <div className="border-border/50 mx-auto max-w-7xl border-b px-4 pt-3 pb-2">
          <div className="text-muted-foreground mb-2 text-xs">品类汇总</div>
            ...
            {categoryBreakdown.map((item) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-xs">({item.itemCount})</span>
                </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-muted-foreground text-sm">商品合计</span>
            ...
            {hasDiscount && (
              <div className="flex items-baseline gap-2">
                <span className="text-muted-foreground text-sm">折扣</span>
            ...
            {/* 最终报价 */}
            <div className="flex items-baseline gap-2">
              <span className="text-muted-foreground text-sm">最终报价</span>
              <span className="text-primary text-2xl font-bold">¥{formatAmount(finalAmount)}</span>
            </div>
          </div>
        </div>
      </div>
