    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]" resizable>
        ...
        <Tabs defaultValue="general" className="w-full">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={defaultPlan}
                        onValueChange={(v: 'ECONOMIC' | 'COMFORT' | 'LUXURY') => setDefaultPlan(v)}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCurtainLoss({ ...curtainLoss, side: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCurtainLoss({ ...curtainLoss, bottom: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCurtainLoss({ ...curtainLoss, header: Number(e.target.value) })
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setWallpaperLoss({ ...wallpaperLoss, width: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setWallpaperLoss({ ...wallpaperLoss, cut: Number(e.target.value) })
                      }
                    />
                  </div>
                </div>
          ...
          <TabsContent value="bom" className="max-h-[450px] space-y-3 overflow-y-auto py-4 pr-2">
