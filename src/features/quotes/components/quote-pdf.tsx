      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>
              {quote.customer?.address || quote.deliveryAddress || '-'}
            </Text>
          </View>
        </View>
                  ...
                  <View style={styles.tableRow} key={item.id}>
                    <View style={[styles.tableCol, { width: '30%' }]}>
                      ...
                      {item.category === 'ACCESSORY' && (
                        <Text style={{ fontSize: 8, color: '#666' }}>(附件)</Text>
                      )}
                    </View>
                    <View style={[styles.tableCol, { width: '15%' }]}>
                      <Text>
            ...
            <>
              ...
              {unassignedItems.map((item: QuoteItem) => (
                <View style={styles.tableRow} key={item.id}>
                  ...
                  <View style={[styles.tableCol, { width: '15%' }]}>
                    <Text>
                      {item.width && Number(item.width) > 0 ? `${item.width}x${item.height}` : '-'}
                    </Text>
                  </View>
                  <View style={[styles.tableCol, { width: '10%' }]}>
                    <Text>{item.quantity}</Text>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.totalRow}>
            ...
            <Text style={styles.totalValue}>
              {Number(quote.discountAmount) > 0 ? `-${quote.discountAmount}` : '-'}
            </Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>最终金额:</Text>
            <Text style={[styles.totalValue, { fontSize: 12, color: 'red' }]}>
              {quote.finalAmount}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.signature}>
          ...
          <View>
            ...
            <Text style={{ textAlign: 'center', marginTop: 5, fontSize: 8 }}>
