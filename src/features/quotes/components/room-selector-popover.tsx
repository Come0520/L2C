      ...
      <PopoverContent className="w-auto p-0" align={align}>
        {customMode ? (
          ...
          <div className="w-64 p-3">
            <div className="mb-2 text-sm font-medium">自定义空间名称</div>
          ...
          <div className="flex divide-x">
            {roomGroups.map((group) => (
              <div key={group.label} className="min-w-[80px] px-0.5 py-1">
                {/* 分组表头 */}
                <div className="text-muted-foreground mb-0.5 px-2 py-0.5 text-xs font-medium">
                  {group.label}
                </div>
                {/* 选项列表 */}
                <div className="space-y-px">
                  {group.items.map((name) => (
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="h-7 w-full justify-start px-2 text-sm font-normal"
                  ...
                  {group.hasCustom && (
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-primary h-7 w-full justify-start px-2 text-sm font-normal"
