  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {/* 方案选择 */}
        <div>
          <h2 className="mb-4 text-lg font-semibold">选择报价方案</h2>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center space-y-0 space-x-2">
                        ...
                        <FormLabel className="cursor-pointer text-sm font-normal">纱帘</FormLabel>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center space-y-0 space-x-2">
                        ...
                        <FormLabel className="cursor-pointer text-sm font-normal">窗帘盒</FormLabel>
                      </FormItem>
                    )}
                  />
