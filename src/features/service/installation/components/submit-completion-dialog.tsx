 ...
 */
export function SubmitInstallCompletionDialog({
  taskId,
  trigger,
}: SubmitInstallCompletionDialogProps) {
  ...
  return (
    ...
    >
      <DialogTrigger asChild>{trigger || <Button>提交完工</Button>}</DialogTrigger>
      <DialogContent className="sm:max-w-lg">
        ...
        {step === 'CONFIRM' && (
          <DialogFooter>
            ...
            <Button onClick={() => setStep('SIGN')}>下一步 (客户签字)</Button>
          </DialogFooter>
        )}
      </DialogContent>
    </Dialog>
