    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>设置筛选条件精确查找测量任务</DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLocalFilters({
                  ...localFilters,
                  workerId: value === '__ALL__' ? undefined : value,
                })
              }
            >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLocalFilters({
                  ...localFilters,
                  salesId: value === '__ALL__' ? undefined : value,
                })
              }
            >
              <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setLocalFilters({
                  ...localFilters,
                  channel: value === '__ALL__' ? undefined : value,
                })
              }
            >
              <SelectTrigger className="col-span-3">
