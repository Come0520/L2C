...
export function BusinessRulesConfig({
  ...
  const form = useForm<BusinessRulesFormData>({
    ...
    defaultValues: {
      minDiscountRate: propInitialValues?.minDiscountRate ?? 0.8,
      requireApprovalBelow: propInitialValues?.requireApprovalBelow ?? 0.9,
    },
  });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>配置折扣控制规则，低于设定阈值的折扣将触发审批流程</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
