    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <h4 className="text-muted-foreground text-xs font-medium">损耗配置</h4>
        ...
        {/* 默认值配置 */}
        <div className="space-y-2">
          <h4 className="text-muted-foreground text-xs font-medium">默认值配置</h4>
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                max={350}
              />
              <p className="text-muted-foreground text-xs">超过此高度触发超高预警弹窗</p>
            </div>
          </div>
        </div>
