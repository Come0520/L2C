...
export function PermissionMatrix({ data }: PermissionMatrixProps) {
  ...
  const handlePermissionChange = useCallback(
    (roleCode: string, permission: string, value: TriState) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 修改提示 */}
      {hasChanges && (
        <div className="fixed right-4 bottom-4 flex items-center gap-2 rounded-lg border border-amber-300 bg-amber-100 px-4 py-2 text-amber-800 shadow-lg">
