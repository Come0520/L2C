  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <CardContent className="pt-0">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setNewItemInputs({ ...newItemInputs, [groupIndex]: e.target.value })
                  }
                  onKeyDown={(e) => {
        ...
        {/* 添加分组按钮 */}
        <Card
          className="hover:bg-muted/50 flex min-h-[200px] cursor-pointer items-center justify-center border-dashed transition-colors"
