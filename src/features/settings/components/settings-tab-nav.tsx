...
export function SettingsTabNav() {
    ...
    return (
        <nav className="flex items-center gap-1 p-1 rounded-xl bg-white/10 dark:bg-black/20 backdrop-blur-md border border-white/10 overflow-x-auto">
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                active
                                    ? 'bg-white/80 dark:bg-white/20 text-foreground shadow-sm'
