        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>完成企业认证后，可获得认证标识，提升客户信任度</CardDescription>
            </div>
          ...
          {currentStatus === 'rejected' && verificationInfo?.verificationRejectReason && (
            <div className="mt-3 rounded-lg border border-red-200 bg-red-50 p-3 dark:border-red-800 dark:bg-red-900/20">
              <p className="text-sm text-red-700 dark:text-red-400">
                <strong>拒绝原因：</strong>
                {verificationInfo.verificationRejectReason}
              </p>
            </div>
          )}
        </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div
                className="border-muted-foreground/25 hover:border-primary relative flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed p-6 transition-colors"
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <p className="text-muted-foreground text-sm">注册资本</p>
                <p className="font-medium">{verificationInfo?.registeredCapital || '-'}</p>
              </div>
              <div>
                <p className="text-muted-foreground text-sm">认证时间</p>
            ...
            {verificationInfo?.businessScope && (
              <div>
                <p className="text-muted-foreground text-sm">经营范围</p>
