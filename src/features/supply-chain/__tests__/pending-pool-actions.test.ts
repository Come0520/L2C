...
import { getPendingPurchaseItems, assignToSupplier, submitForApproval, mergeToPurchaseOrder } from '../actions/pending-pool-actions';
...
describe('Pending Pool Actions', () => {
    ...
    describe('getPendingPurchaseItems', () => {
        it('should require authentication', async () => {
            ...
            await expect(getPendingPurchaseItems({ page: 1, pageSize: 20, itemType: 'ALL' })).rejects.toThrow('Unauthorized');
        });
    ...
    describe('submitForApproval', () => {
        ...
        it('should throw if no DRAFT pos exist', async () => {
            ...
            await expect(submitForApproval({ poIds: ['123e4567-e89b-12d3-a456-426614174005'] })).rejects.toThrow('没有可提交的采购单');
        });
    });
