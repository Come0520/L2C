...
import { z } from 'zod';
import { confirmPoPayment } from '../actions/po-actions';
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={paymentMethod}
                onValueChange={(val: ConfirmPaymentFormData['paymentMethod']) =>
          ...
          <div className="space-y-2">
            ...
            <Input id="paymentTime" type="datetime-local" {...register('paymentTime')} />
            {errors.paymentTime && (
          ...
          <div className="space-y-2">
            <Label>付款凭证 (可选)</Label>
            {voucherImg ? (
              <div className="bg-muted/50 relative flex h-40 w-full items-center justify-center rounded-md border p-2">
                <Image
                  src={voucherImg}
          ...
          <div className="space-y-2">
            ...
            <Textarea id="remark" rows={3} placeholder="填写付款备注..." {...register('remark')} />
