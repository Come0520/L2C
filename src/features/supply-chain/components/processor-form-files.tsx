      ...
      <div className="space-y-2">
        ...
        <div className="rounded-md border p-4">
          <PhotoUpload
            ...
            maxFiles={1}
          />
          <p className="text-muted-foreground mt-2 text-xs">支持 JPG, PNG 格式，用于预览</p>
        </div>
      </div>
    );
  };
  ...
  return (
    <div className="grid gap-6 py-4">
      ...
      <div className="space-y-4">
        <h3 className="border-b pb-2 text-sm font-medium">合同信息</h3>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                ...
                <FormDescription>系统将在到期前30天自动提醒</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
      ...
      {/* 资质区域 */}
      <div className="space-y-4">
        <h3 className="border-b pb-2 text-sm font-medium">企业资质</h3>
        <FormField
          control={form.control}
          ...
          render={({ field }) => (
            <FormItem>
              <FormControl>
                <SingleImageUpload label="营业执照" value={field.value} onChange={field.onChange} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
      ...
      {/* 银行账户区域 */}
      <div className="space-y-4">
        <h3 className="border-b pb-2 text-sm font-medium">财务信息</h3>
        <div className="grid grid-cols-2 gap-4">
          <FormField
            control={form.control}
            name="bankName"
