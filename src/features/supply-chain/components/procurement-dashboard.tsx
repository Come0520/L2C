      ...
      <motion.div variants={itemVariants}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">待确认/待处理采购单</p>
          </CardContent>
        </Card>
      </motion.div>
      <motion.div variants={itemVariants}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">物流已发出订单</p>
          </CardContent>
        </Card>
      </motion.div>
      <motion.div variants={itemVariants}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">延期未送达订单</p>
          </CardContent>
        </Card>
      </motion.div>
      <motion.div variants={itemVariants}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">已归档完结订单</p>
          </CardContent>
        </Card>
      </motion.div>
    </motion.div>
