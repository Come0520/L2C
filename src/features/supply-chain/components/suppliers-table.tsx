...
const SupplierTableRow = React.memo(function SupplierTableRow({
  supplier,
  onEdit,
  onDelete,
  ...
  return (
    <TableRow key={supplier.id}>
      ...
      <TableCell>{supplier.paymentPeriod === 'MONTHLY' ? '月结' : '现结'}</TableCell>
      ...
      <TableCell>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="text-red-600" onClick={() => onDelete(supplier.id)}>
      ...
      <div className="rounded-md border">
        <Table>
          ...
          <TableBody className="content-visibility-auto">
            ...
            {data.length === 0 && <EmptyTableRow colSpan={6} message="暂无数据" />}
          </TableBody>
        </Table>
      </div>
