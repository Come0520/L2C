...
export const ROLES: Record<string, RoleDefinition> = {
  ...
  MANAGER: {
    ...
    permissions: [
      ...
      PERMISSIONS.FINANCE.REPORT_VIEW,
      PERMISSIONS.FINANCE.REPORT_EXPORT,
      PERMISSIONS.FINANCE.JOURNAL_VIEW,
      PERMISSIONS.FINANCE.TRANSFER_VIEW,
  ...
  FINANCE: {
    ...
    permissions: [
      ...
      PERMISSIONS.FINANCE.AR_VIEW,
      PERMISSIONS.FINANCE.AR_CREATE,
      PERMISSIONS.FINANCE.AR_RECONCILE,
      PERMISSIONS.FINANCE.AP_VIEW,
      PERMISSIONS.FINANCE.AP_CREATE,
      PERMISSIONS.FINANCE.AP_RECONCILE,
      ...
      PERMISSIONS.FINANCE.TRANSFER_VIEW,
      PERMISSIONS.FINANCE.TRANSFER_CREATE,
      PERMISSIONS.FINANCE.CONFIG_MANAGE,
      PERMISSIONS.FINANCE.LABOR_VIEW,
      // 供应链 - 查看（付款核对）
      PERMISSIONS.SUPPLY_CHAIN.VIEW,
      // 渠道 - 佣金和结算
