      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              'glass-liquid absolute z-50 mt-2 rounded-full border border-white/20 p-1.5 dark:border-white/10',
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="bg-primary-500/20 dark:bg-primary-500/30 absolute inset-0 rounded-full"
                      transition={{
                        type: 'spring',
                        stiffness: 500,
                        damping: 30,
...
export function Logo({ className }: LogoProps) {
  return (
    <div className={className}>
      <div className="from-primary-500 to-primary-600 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-linear-to-br shadow-lg">
