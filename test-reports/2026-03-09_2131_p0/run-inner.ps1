...
$start   = Get-Date
$logFile = 'test-reports\2026-03-09_2131_p0\e2e-full.log'
$sumFile = 'test-reports\2026-03-09_2131_p0\summary.txt'

'=' * 60 | Out-File $logFile -Encoding UTF8
"[21:31:07] 🔴 P0 冒烟测试  开始: $start" | Out-File $logFile -Append -Encoding UTF8
...
# playwright 会自动通过 webServer 配置启动并等待 standalone 服务就绪
